...
import { Briefcase, CaretDown, Clock, Heart, MapPin, SquaresFour, Storefront, Student } from '../icons';
...
const filtered = computed(() => visibleJobs.value.filter((job) => type.value === 'alles' || job.type === type.value));
